...
from networkx.algorithms import bipartite   #that's for the graph a bipartite is a graph whose vertices can be divided into 2 sets 
import ast
...
plt.show()   #that is used for showing the graph 
